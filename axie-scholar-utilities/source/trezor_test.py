...
from axie.utils import get_nonce, TIMEOUT_MINS
...
class TrezorPayment:
    ...
    def __init__(self, name, from_acc, to_acc, amount):
        ...
        self.bip32_path = parse_path("m/44'/60'/0'/0/0")
        self.address = ethereum.get_address(self.client, self.bip32_path, True)
...
if __name__ == '__main__':
    # this will send 1 SLP from 1 acc to another
    t = TrezorPayment(
        "Test payment",
        "ronin:your_origin_account_here",
        "ronin:your_destination_account_here",
        1
    )
    t.execute()