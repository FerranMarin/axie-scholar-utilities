...
function axie-utils-gen-secrets {
    poetry run python axie_scholar_cli.py generate_secrets files/payments.json files/secrets.json
}
# Alias to generate payments
function axie-utils-gen-payments {
    poetry run python axie_scholar_cli.py generate_payments files/payments.csv files/payments.json
}
# Alias to mass update secrets
function axie-utils-mass-update {
    poetry run python axie_scholar_cli.py mass_update_secrets files/update.csv files/secrets.json
}
# Alias to execute claims
function axie-utils-claim {
    poetry run python axie_scholar_cli.py claim files/payments.json files/secrets.json
}
# Alias to execute payments
function axie-utils-payout {
    poetry run python axie_scholar_cli.py payout files/payments.json files/secrets.json
}
# Alias to execute auto-payments (no confirmation)
function axie-utils-auto-payout {
    poetry run python axie_scholar_cli.py payout files/payments.json files/secrets.json -y
}
# Alias to execute axie transfers
function axie-utils-transfer-axies {
    poetry run python axie_scholar_cli.py transfer_axies files/transfers.json files/secrets.json
}
#Alias to generate transfers file
function axie-utils-gen-transfers {
    poetry run python axie_scholar_cli.py generate_transfer_axies files/transfers.csv files/transfers.json
}
# Alias to execute generate_qr
function axie-utils-gen-QR {
    poetry run python axie_scholar_cli.py generate_QR files/payments.json files/secrets.json
}
#Alias to generate breedings file
function axie-utils-gen-breedings {
    poetry run python axie_scholar_cli.py generate_breedings files/breedings.csv files/breedings.json
}
# Alias to breed axies
function axie-utils-axie-breeding {
    poetry run python axie_scholar_cli.py axie_breeding files/breedings.json files/secrets.json
}
# Alias to morph axies by ronin addresses
function axie-utils-axie-morphing($ronin_list) {
    poetry run python axie_scholar_cli.py axie_morphing files/secrets.json $ronin_list
}
