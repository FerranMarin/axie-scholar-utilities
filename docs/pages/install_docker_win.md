...
If you go this route, I recomend also setting up these alias in [PowerShell](https://docs.microsoft.com/en-us/powershell/) to execute commands easier:
    ...
    # Alias to execute claims
        function axie-utils-claim {docker run -it -v ${PWD}/${1}:/opt/app/files/payments.json -v ${PWD}/${2}:/opt/app/files/secrets.json epith/axie-scholar-utilities claim files/payments.json files/secrets.json}
